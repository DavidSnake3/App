...
export const WIDGET_META: Record<WidgetId, { name: string; desc: string; icon: React.ReactNode; defaultSize: WidgetSize }> = {
  ...
  acciones: { name: 'Accesos rápidos', desc: 'Movimientos, deudas, cuentas, tarjetas y préstamos', icon: <LayoutGrid size={16} />, defaultSize: 'lg' },
  ...
  divisas: { name: 'Tipo de cambio', desc: 'Cuánto vale el dólar, el euro y más', icon: <TrendingUp size={16} />, defaultSize: 'lg' },
